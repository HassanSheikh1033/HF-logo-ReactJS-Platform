          ...
          <div className="flex items-center justify-between absolute top-0 left-0  bg-base-100  z-50 w-full p-3">
            <div className="flex items-center font-bold italic text-2xl">
              <Image
                ...
                alt="logo"
              />
              <span className="text-secondary ml-2">HF </span>Logo
            </div>
            <div className="flex items-center">
              ...
              <button className="btn ml-5"
                ...
                Download <Download className="w-4" />
              </button>
            </div>
          </div>
        ...
        <div className="md:w-1/4 p-5">
          ...
          <div className="mt-4">
            <div className="flex justify-between mb-3 text-gray-500">
              <label className="badge badge-ghost">Size</label>
          ...
          <div className="mt-4">
            <div className="flex justify-between mb-3 text-gray-500">
              <label className="badge badge-ghost">Border</label>
          ...
          <div className="mt-4">
            <div className="flex justify-between mb-3 text-gray-500">
              <label className="badge badge-ghost">Rounded</label>
              <span>{radius} px</span>
            </div>
            <input
              type="range"
        ...
        <div className="modal-box">
          ...
          {isDownloading ? (
            ...
            <div className="text-center my-4">
              <p className="text-md font-bold">The download was completed successfully! 🎉</p>
            </div>
          ) : (
            <div>
              <h3 className="font-bold text-lg text-center mb-4">Choose a format</h3>
